import{V as p}from"./index.61587c50.js";function $(t){const n=t-1;return n*n*n+1}function V(t){return--t*t*t*t*t+1}function q(t,{delay:n=0,duration:a=400,easing:e=$,x:i=0,y:f=0,opacity:s=0}={}){const o=getComputedStyle(t),r=+o.opacity,u=o.transform==="none"?"":o.transform,y=r*(1-s),[m,c]=p(i),[d,_]=p(f);return{delay:n,duration:a,easing:e,css:(l,g)=>`
